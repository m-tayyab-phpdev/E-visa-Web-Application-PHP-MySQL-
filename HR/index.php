...
<head>
    ...
    <style>
        body {
            background: url('assets/travel.jpg') no-repeat center center/cover;
            color: white;
    ...
    <div class="card">
        ...
        <form action="php/loginbackend.php" method="post">
            ...
            <div class="form-group mb-3">
                <input type="email" class="form-control" placeholder="Enter your email" name="email" style="color: black;" required>
            </div>
            <div class="form-group mb-3">
                <input type="password" class="form-control" placeholder="Enter your password" name="password" style="color: black;" required>
            </div>
