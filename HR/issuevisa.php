...
if (isset($_POST['btn-issue'])) {
    ...
    if ($run_issue_visa) {
        echo "<script>alert('Visa status updated'); window.location.replace('issuevisa.php');</script>";
    }
}
...
<div id="layoutSidenav_content">
    ...
    <td>' . $row['marks'] . '</td>';
                                    ...
                                    if ($application != "closed.png") {
                                        ...
                                        echo '<td><img src="' . $path . $row['application_status'] . '" style="width: 60px; height: auto;"></td>';
                                    }
                                    if ($application != "closed.png") {
