    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="containter">
                ...
                <div class="receipt-container">
                    ...
                    $id = $_SESSION['ID'];
                    $get = "Admin";
                    $fetch = "SELECT * FROM (feedback a, users b) WHERE (a.sender_id = '$id' AND a.receiver_id = b.user_id AND b.user_type = '$get')";
        ...
        <div class="ticket">
            ...
            <div class="ticket-body">
                <p><strong>Admin Name:</strong> ' . $new_row['user_name'] . '</p>
