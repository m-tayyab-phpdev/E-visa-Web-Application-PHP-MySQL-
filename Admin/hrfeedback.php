...
if (isset($_GET['id'])) {
    ...
    if ($run) {
        echo "<script>alert('Feedback removed'); window.location.replace('hrfeedback.php');</script>";
    }
}
?>
<style>
    ...
    <main>
        ...
        <div class="ticket">
            ...
            <div class="ticket-body">
                ...
                <p><a href="hrfeedback.php?id=' . $new_row['feedback_id'] . '" class="btn btn-danger" style="font-weight: bold;">Remove</a></p>
            </div>
        </div>';
