...
if (isset($_GET['id'])) {
    $var_id = $_GET['id'];
    $sql = "DELETE FROM `feedback` WHERE `feedback_id` = '$var_id'";
    $run = mysqli_query($con, $sql);
    if ($run) {
        echo "<script>alert('Feedback removed'); window.location.replace('applicantfeedback.php');</script>";
    }
}
?>
<style>
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="receipt-container">
                    ...
                    $id = $_SESSION['ID'];
                    $type = "Applicant";
                    $fetch = "SELECT * FROM feedback a, users b WHERE receiver_id = '$id' AND sender_id = b.user_id AND b.user_type = '$type'";
        ...
        <div class="ticket">
            ...
            <div class="ticket-body">
                ...
                <p><a href="applicantfeedback.php?id=' . $new_row['feedback_id'] . '" class="btn btn-danger" style="font-weight: bold;">Remove</a></p>
            </div>
        </div>';
