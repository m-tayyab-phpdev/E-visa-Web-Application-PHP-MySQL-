...
<head>
    ...
    <style>
        ...
        .verify-button {
            ...
            background-color: #0078D7;
            color: #ffffff; /* Ensures text color inside the button is white */
    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <p style="text-align: center;">
                <a href="http://localhost/ali-visa/Admin/php/verify.php?email=' . urlencode($var_email) . '" class="verify-button" style="color:white;">Verify My Account</a>
            </p>
        ...
        if ($var_password == $var_cpassword) {
            ...
            if ($run_sql) {
                if (EMAIL($var_email, $var_name)) {
                    $_SESSION['msg'] = "Email has been send";
