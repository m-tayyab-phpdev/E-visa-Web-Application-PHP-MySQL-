<?php
include 'format.php';
$sql = ["SELECT * FROM `users` WHERE `user_type` = 'Applicant'", "SELECT * FROM `users` WHERE `user_type` = 'HR'", "SELECT * FROM `applicant_info` WHERE `application_status` = 'closed.png'", "SELECT * FROM `applicant_info` WHERE `application_status` = 'pending'", "SELECT * FROM `applicant_info` WHERE `interview` = 'Done'", "SELECT * FROM `applicant_info` WHERE `visa_status` = 'Visa Issued'"];
