                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="termsandcondition.php"><i class="fas fa-file-alt"></i>&nbsp; New application</a>
                                <a class="nav-link" href="viewapplication.php"><i class="fas fa-folder-open"></i>&nbsp; Old applications</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseFeedback" aria-labelledby="headingFeedback">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="interviewinfo.php"><i class="fas fa-eye"></i>&nbsp; View Interview</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="feedbacktohr.php"><i class="fas fa-ticket-alt"></i>&nbsp; Ticket to HR</a>
                                <a class="nav-link" href="feedbacktoadmin.php"><i class="fas fa-ticket-alt"></i>&nbsp; Ticket to Admin</a>
                            </nav>
                        </div>
