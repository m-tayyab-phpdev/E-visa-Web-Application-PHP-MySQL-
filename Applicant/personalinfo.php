        ...
        <div class="container-fluid px-4 mb-4">
            ...
            <div class="container">
                ...
                <div style="margin-top: 20px; margin-bottom: 10px; display: flex; justify-content: space-between; align-items: center; position: relative; width: 100%;">
                    <a href="visainfo.php" style="text-decoration: none;">
                    ...
                    <a href="personalinfo.php" style="text-decoration: none;">
                    ...
                    <a href="travelinfo.php" style="text-decoration: none;">
                        <div style="width: 150px; height: 40px; border-radius: 20px; background-color: #d3d3d3; color: #fff; text-align: center; line-height: 40px; z-index: 2;">Travel & Interview</div>
                    </a>
                    <div style="flex-grow: 1; height: 5px; background-color: #d3d3d3; margin: 0 10px;"></div>
                    <a href="finalapplication.php" style="text-decoration: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div style="border: 1px solid #ced4da; border-radius: 4px; width: 150px; height: 150px; margin: 10px auto; background-color: #f8f9fa; display: flex; justify-content: center; align-items: center;">
                                    <img id="previewImage" src="uploads/avatar.webp" alt="Attach image" style="max-width: 100%; max-height: 100%;">
                                </div>
                                <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-1">
                                <input type="file" required id="applicantPicture" name="picture"  onchange="previewImage(event)">
                                </div>
                                </div>
                            </div>
